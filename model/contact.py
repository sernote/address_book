...
class Contact:
    def __init__(self, firstname= None, middlename= None, lastname= None, nickname= None, title= None, company= None,
                 ...
                 id= None, all_phones_from_page= None, all_mails_from_page= None):
        ...
        self.all_mails_from_page=all_mails_from_page

    def __repr__(self):
        return "%s:%s:%s:%s:%s" % (self.id, self.firstname, self.lastname, self.home, self.email)
